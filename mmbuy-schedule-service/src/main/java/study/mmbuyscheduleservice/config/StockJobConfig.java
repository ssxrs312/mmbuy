...
import study.mmbuyscheduleservice.job.StockSimpleJob;
...
public class StockJobConfig {
    ...
    public JobScheduler simpleJobScheduler(final SimpleJob simpleJob, @Value("${stockJob.cron}") final String cron,
